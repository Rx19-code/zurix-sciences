...
import { ChevronLeft, Beaker, FlaskConical, BookOpen, GitCompare, Info, Clock, Award, RefreshCw, Tag, Layers } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-5">
            ...
            {tab === 'protocols' && <ProtocolsContent peptide={peptide} />}
            {tab === 'research' && <ResearchContent peptide={peptide} />}
            {tab === 'synergy' && <SynergyContent peptide={peptide} />}
          </div>
